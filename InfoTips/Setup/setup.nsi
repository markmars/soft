...
; 安装程序初始定义常量
!define PRODUCT_PATH "土司软件"
!define PRODUCT_NAME "外汇黄金宝"
!define PRODUCT_VERSION "v2.1"
!define PRODUCT_PUBLISHER "土司软件"
!define PRODUCT_Install_KEY "Software\外汇黄金宝\"
...
Section -Post
	CreateShortCut "$DESKTOP\外汇黄金宝.lnk" "$INSTDIR\InfoTips.exe"	
	CreateShortCut "$SMPROGRAMS\外汇黄金宝\外汇黄金宝.lnk" "$INSTDIR\InfoTips.exe"
	CreateShortCut "$SMPROGRAMS\外汇黄金宝\卸载外汇黄金宝.lnk" "$INSTDIR\uninst.exe"
...
Function .onInit
	...
	${if} $INSTDIR == ""
		StrCpy $INSTDIR "$PROGRAMFILES\外汇黄金宝\"
	${EndIf}
FunctionEnd
...
Section Uninstall
	...
	RMDir /r $INSTDIR
	;删除快捷方式
	Delete "$DESKTOP\外汇黄金宝.lnk"
	Delete "$SMPROGRAMS\外汇黄金宝\外汇黄金宝.lnk"
	Delete "$SMPROGRAMS\外汇黄金宝\卸载外汇黄金宝.lnk"
	Delete "$SMPROGRAMS\外汇黄金宝\"
