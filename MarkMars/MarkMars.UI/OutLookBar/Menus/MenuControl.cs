...
namespace MarkMars.UI.OutLookBar.Menus
{
	...
	[Designer(typeof(MarkMars.UI.OutLookBar.Menus.MenuControlDesigner))]
	public class MenuControl : ContainerControl, IMessageFilter
	{
		...
		static MenuControl()
		{
			...
			_menuImages = ResourceUtil.LoadImageListResource(Type.GetType("MarkMars.UI.OutLookBar.Menus.MenuControl"),
