...
using MarkMars.UI.OutLookBar.WinControls;
using MarkMars.UI.OutLookBar.General;
using MarkMars.UI.OutLookBar.CommandBars;
...
namespace MarkMars.UI.OutLookBar.Menus
{
	...
	public class MenuItemEx : MenuItem
	{
		...
		static MenuItemEx()
		{
			...
			Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("MarkMars.UI.OutLookBar.Menus.MenuItemEx"));
			ResourceManager rm = new ResourceManager("MarkMars.UI.OutLookBar.Resources.ImagesMenu", thisAssembly);
