...
namespace MarkMars.UI.OutLookBar.WinControls
{
	...
	public class ListViewEx : ListView
	{
		...
		private void InitializeCheckBoxesImageList()
		{
			...
			Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("MarkMars.UI.OutLookBar.WinControls.ListViewEx"));
			ResourceManager rm = new ResourceManager("MarkMars.UI.OutLookBar.Resources.SortedListView", thisAssembly);
