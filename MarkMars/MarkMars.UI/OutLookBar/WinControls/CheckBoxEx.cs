...
namespace MarkMars.UI.OutLookBar.WinControls
{
	...
	public class CheckBoxEx : System.Windows.Forms.CheckBox
	{
		...
		public CheckBoxEx()
		{
			...
			checkMarkChecked = ResourceUtil.LoadBitmapResource(Type.GetType("MarkMars.UI.OutLookBar.WinControls.CheckBoxEx"),
				                                "MarkMars.UI.OutLookBar.Resources.Controls", "CheckMarkChecked");
			Debug.Assert(checkMarkChecked != null);
			checkMarkUnchecked = ResourceUtil.LoadBitmapResource(Type.GetType("MarkMars.UI.OutLookBar.WinControls.CheckBoxEx"),
				                                "MarkMars.UI.OutLookBar.Resources.Controls", "CheckMarkUnchecked");
