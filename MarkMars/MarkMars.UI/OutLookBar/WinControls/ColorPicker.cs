...
namespace MarkMars.UI.OutLookBar.WinControls
{
	...
	public class ColorPicker : System.Windows.Forms.UserControl
	{
		...
		public ColorPicker()
		{
			Assembly thisAssembly = Assembly.GetAssembly(Type.GetType("MarkMars.UI.OutLookBar.WinControls.ColorPicker"));
			rm = new ResourceManager("MarkMars.UI.OutLookBar.Resources.ImagesColorPicker", thisAssembly);
