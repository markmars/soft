...
namespace MarkMars.UI
{
    ...
    public class TreeGridView : DataGridView
    {
        ...
        private Boolean _isFullRowSelect = false;
        ...
        public TreeGridView()
        {
            ResourceManager resourceManager = new ResourceManager("MarkMars.UI.Properties.Resources", System.Reflection.Assembly.GetExecutingAssembly());
            this.rOpen = (Bitmap)resourceManager.GetObject("minus");
            this.rClosed = (Bitmap)resourceManager.GetObject("plus");

            // Control when edit occurs because edit mode shouldn't start when expanding/collapsing
            this.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2;//.EditProgrammatically;
            ...
            //this.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(249, 253, 255);
            //this.ColumnHeadersHeight = 30;
            //this.BackgroundColor = Color.FromArgb(249, 253, 255);
        ...
        protected override void OnKeyDown(KeyEventArgs e)
        {
            ...
            if (!e.Handled)
            {
                ...
                else if (e.KeyCode == Keys.Enter && !this.IsCurrentCellInEditMode)
                {
                    ...
                    if (this.CurrentCell != null) // 2010-09-19 Chenx 如果控件中没行记录，直接回车会出错。
                    {
        ...
        {
            get { return this._isFullRowSelect; }
            set
            {
                this._isFullRowSelect = value;
            }
        }
        ...
        internal protected virtual void SiteNode(TreeGridNode node)
        {
            ...
            if (currentRow != null)
            {
                ...
                {
                    while (currentRow.IsExpanded && currentRow.HasChildren)
                    {
                        currentRow = currentRow.Nodes[currentRow.Nodes.Count - 1];
                    }
        ...
        protected override void OnRowEnter(DataGridViewCellEventArgs e)
        {
            ...
            if ((this.SelectionMode == DataGridViewSelectionMode.CellSelect && this._isFullRowSelect) ||
                (this.SelectionMode == DataGridViewSelectionMode.FullRowSelect &&
