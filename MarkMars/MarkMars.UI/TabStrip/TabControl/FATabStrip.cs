...
using MarkMars.UI.TabStrip.BaseClasses;
using MarkMars.UI.TabStrip.Design;

namespace MarkMars.UI.TabStrip.TabControl
{
    ...
    public class FATabStrip : BaseStyledPanel, ISupportInitialize, IDisposable
    {
        ...
        private static Font defaultFont = new Font("ËÎÌו", 9.00f, FontStyle.Regular);
        ...
        private void OnDrawTabPage(Graphics g, FATabStripItem currentItem)
        {
            ...
            if (RightToLeft == RightToLeft.No)
            {
                ...
                if (currentItem == SelectedItem)
                {
                    brush = new LinearGradientBrush(buttonRect, SystemColors.ControlLightLight, this.backColor, LinearGradientMode.Vertical);
                }
                else
                {
            ...
            if (RightToLeft == RightToLeft.Yes)
            {
                ...
                {
                    brush =
                        new LinearGradientBrush(buttonRect, SystemColors.ControlLightLight, this.backColor,
