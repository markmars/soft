	...
	public class SQLServerConnectionSetting
	{
		...
		public static SQLServerConnectionSetting GetInstance(string strName)
		{
            if (string.IsNullOrEmpty(strName))
                return GetInstance(Utility.AssemblyTitle);
		...
		private void Load()
		{
            RegistryKey rkRoot = Registry.CurrentUser.OpenSubKey("Software\\MarkMars\\" + m_strName, false);
			if (rkRoot == null)
				return;
		...
		public void Save()
		{
            ...
            RegistryKey rkCompany = rkRoot.CreateSubKey("MarkMars");
